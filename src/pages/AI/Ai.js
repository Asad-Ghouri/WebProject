...
const alanKey =
  "344257a638daf4fec41a2af6566fb1152e956eca572e1d8b807a3e2338fdd0dc/stage";
const Ai = () => {
  useEffect(() => {
    alanBtn({
      key: alanKey,
      ...
      <div className="aicontainer">
        <div className="aiwrapper">
          ...
          <div className="">
            <img
              className="imgai"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8ylcI69CEyRPrK1NFKDGG-gm6-hIMe3L0bJGTLsGj14wnQbtfgXbpBdjNfxTIHrg86XY&usqp=CAU"
              alt=""
            />
          </div>
          <div className="smalltalk">
            ...
            <div className="talk">
              <ul>
                <li>
                  What is the weather|temperature|humidity|pressure in
                  "Location"
                </li>
